...
#define LCD_RST P0_6       //_RES  hardware reset   复位，协调器使用P0_6进行复位，释放串口2 
#else
...
{
#ifdef ZDO_COORDINATOR
    P0SEL &= 0xBE; //让P0.0 P0_6为普通IO口，协调器使用P0_6进行复位
    P0DIR |= 0x41; //让P0.0 P0_6为为输出
#else
    P0SEL &= 0xFE; //让P0.0为普通IO口，
    P0DIR |= 0x01; //让P0.0 P0_6为为输出
#endif
